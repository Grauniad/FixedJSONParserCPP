...
SimpleParsedJSON<Fields...>::SimpleParsedJSON(UnknownFieldMode unknownFieldMode)
    : currentField(nullptr),
      depth(0)
{
    switch(unknownFieldMode) {
    case UnknownFieldMode::IGNORE:
        skip_unknown = true;
        break;
    case UnknownFieldMode::ERROR: [[fallthrough]];
    default:
        skip_unknown = false;
        break;
    }
